...
此功能分支是针对`32`位操作系统的。若要支持`64`位操作系统，请切换至[主分支](https://github.com/stuartZhang/request-window-attention/)。
...
2. 【链接库】输出格式会附增`C++`头文件，以描述链接库接口格式。
   1. 文件位置`target-win-ia32\<profile>\request-window-attention.h`
